  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-10">
      <header className="mb-8">
        <h1 className="text-2xl font-semibold tracking-tight text-preto">Certificados fiscais</h1>
        <p className="mt-1 text-sm text-cinza/70">
          Certificados A1 das SPEs, usados para consultar as notas direto na SEFAZ. O .pfx e a senha
          ficam cifrados e nunca saem do servidor.
        </p>
      </header>
